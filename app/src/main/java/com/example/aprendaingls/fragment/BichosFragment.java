 ...
 */
public class BichosFragment extends Fragment implements View.OnClickListener {   //Implementa OnClick para utilizar o THIS como parametro

    private ImageButton buttonCao, buttonGato, buttonLeao, buttonMacaco,
            buttonOvelha, buttonVaca;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        buttonCao = view.findViewById(R.id.buttonCao);               //Utiliza a VIEW para poder acessar os fragments
